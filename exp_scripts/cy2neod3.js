...
relationship_click_event = function (_relationship) {
	...
	//var _new_relation ;
	//var _new_relation = window.prompt("他們的關係是？", _relationship.type); // windows promot
	

//@@20180807修改關係改為下拉選單，採用CBDB中的十種關係
	//bootbox.setLocale('zh_TW'); //語系
    ...
    value: _relationship.type ,
    callback: function (result) {
        var _new_relation = result; //修改後的關係
/*
    }
			});// end bootbox
*/
